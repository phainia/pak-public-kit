...
local UMG_SleepingOwl_FruitItem1_C = Base:Extend("UMG_SleepingOwl_FruitItem1_C")

function UMG_SleepingOwl_FruitItem1_C:OnConstruct()
end

function UMG_SleepingOwl_FruitItem1_C:OnDestruct()
end

function UMG_SleepingOwl_FruitItem1_C:OnItemUpdate(_data, datalist, index)
  self.petTypeIcons = {
    self.petTypeIcon1,
    self.petTypeIcon2
  }
  ...
  if self.data then
    ...
    Log.Error("SleepingOwl data is nil")
  end
end

function UMG_SleepingOwl_FruitItem1_C:SetPetTypeIcon(_dicTypes)
...
function UMG_SleepingOwl_FruitItem1_C:OnDeactive()
end

return UMG_SleepingOwl_FruitItem1_C
