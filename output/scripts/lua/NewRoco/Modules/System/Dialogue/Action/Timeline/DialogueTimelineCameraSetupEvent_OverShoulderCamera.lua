...
local DialogueTimelineCameraSetupEvent_OverShoulderCamera = Base:Extend("DialogueTimelineCameraSetupEvent_OverShoulderCamera")
FsmUtils.MergeMembers(Base, DialogueTimelineCameraSetupEvent_OverShoulderCamera, {
  {
    name = "TargetActorID",
  ...
  },
  {
    name = "PitchOffset",
    type = "float",
    display_name = "\230\145\135\232\135\130\229\158\130\231\155\180\230\151\139\232\189\172\232\167\146\229\186\166"
  }
})

function DialogueTimelineCameraSetupEvent_OverShoulderCamera:Ctor(name, properties)
  Base.Ctor(self, name, properties)
  self.CameraType = Enum.NpcInteractCameraType.NIC_2
end

function DialogueTimelineCameraSetupEvent_OverShoulderCamera:FillCameraRequestParams(Config)
...
return DialogueTimelineCameraSetupEvent_OverShoulderCamera
