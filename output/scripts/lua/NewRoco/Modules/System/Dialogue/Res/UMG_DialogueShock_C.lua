...
local UMG_DialogueShock_C = DialogueMainPanelBase:Extend("UMG_DialogueShock_C")

function UMG_DialogueShock_C:OnConstruct()
  DialogueMainPanelBase.OnConstruct(self)
  self:BindInputAction()
end

function UMG_DialogueShock_C:OnDestruct()
  DialogueMainPanelBase.OnDestruct(self)
end

function UMG_DialogueShock_C:BindInputAction()
...
function UMG_DialogueShock_C:NextDialogue()
  self:OnDialogueClick()
end

return UMG_DialogueShock_C
