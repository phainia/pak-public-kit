...
local UMG_DialogueMain_C = DialogueMainPanelBase:Extend("UMG_DialogueMain_C")

function UMG_DialogueMain_C:OnConstruct()
  DialogueMainPanelBase.OnConstruct(self)
  self:BindInputAction()
end

function UMG_DialogueMain_C:OnDestruct()
  DialogueMainPanelBase.OnDestruct(self)
end

function UMG_DialogueMain_C:BindInputAction()
...
function UMG_DialogueMain_C:NextDialogue()
  self:OnDialogueClick()
end

return UMG_DialogueMain_C
