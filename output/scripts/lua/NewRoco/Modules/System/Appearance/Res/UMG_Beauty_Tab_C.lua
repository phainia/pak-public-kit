local UMG_Beauty_Tab_C = _G.NRCViewBase:Extend("UMG_Beauty_Tab_C")

function UMG_Beauty_Tab_C:OnConstruct()
  self.data = self.module:GetData("AppearanceModuleData")
  self:OnAddEventListener()
end

function UMG_Beauty_Tab_C:OnActive()
end

function UMG_Beauty_Tab_C:OnDeactive()
end

function UMG_Beauty_Tab_C:OnAddEventListener()
...
function UMG_Beauty_Tab_C:OnDestruct()
end

function UMG_Beauty_Tab_C:OnBtnSkinClicked(_IsPlaySound)
...
function UMG_Beauty_Tab_C:OnBtnHairClicked()
...
function UMG_Beauty_Tab_C:OnBtnEyebrowClicked()
  self:UnChooseAnimation()
...
function UMG_Beauty_Tab_C:OnBtnEyelashClicked()
  self:UnChooseAnimation()
...
function UMG_Beauty_Tab_C:OnBtnEyeColorClicked()
  self:UnChooseAnimation()
...
function UMG_Beauty_Tab_C:OnBtnMakeUpClicked()
  self:UnChooseAnimation()
...
function UMG_Beauty_Tab_C:UnChooseAnimation(_IsPlaySound)
