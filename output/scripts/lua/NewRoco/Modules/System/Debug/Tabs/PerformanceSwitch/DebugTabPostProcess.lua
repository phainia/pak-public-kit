...
local DebugTabPostProcess = Base:Extend("DebugTabPostProcess")

function DebugTabPostProcess:Ctor()
  Base.Ctor(self)
end

local GroupName = "PostProcessQuality"

function DebugTabPostProcess:SetupTabs()
