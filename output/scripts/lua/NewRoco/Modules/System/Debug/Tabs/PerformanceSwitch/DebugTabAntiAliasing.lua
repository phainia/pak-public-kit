...
local DebugTabAntiAliasing = Base:Extend("DebugTabAntiAliasing")

function DebugTabAntiAliasing:Ctor()
  Base.Ctor(self)
end

local GroupName = "AntiAliasingQuality"

function DebugTabAntiAliasing:SetupTabs()
