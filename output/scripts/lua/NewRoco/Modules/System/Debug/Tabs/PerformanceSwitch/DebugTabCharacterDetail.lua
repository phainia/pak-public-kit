...
local DebugTabCharacterDetail = Base:Extend("DebugTabCharacterDetail")

function DebugTabCharacterDetail:Ctor()
  Base.Ctor(self)
end

local GroupName = "CharacterDetailQuality"

function DebugTabCharacterDetail:SetupTabs()
