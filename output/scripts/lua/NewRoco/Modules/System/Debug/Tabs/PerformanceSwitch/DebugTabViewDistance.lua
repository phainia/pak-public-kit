...
local DebugTabViewDistance = Base:Extend("DebugTabViewDistance")

function DebugTabViewDistance:Ctor()
  Base.Ctor(self)
end

local GroupName = "ViewDistanceQuality"

function DebugTabViewDistance:SetupTabs()
