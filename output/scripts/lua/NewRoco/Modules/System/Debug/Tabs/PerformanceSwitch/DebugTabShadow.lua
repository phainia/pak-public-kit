...
local DebugTabShadow = Base:Extend("DebugTabShadow")

function DebugTabShadow:Ctor()
  Base.Ctor(self)
end

local GroupName = "ShadowQuality"

function DebugTabShadow:SetupTabs()
