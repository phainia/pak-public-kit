...
local DebugTabShading = Base:Extend("DebugTabShading")

function DebugTabShading:Ctor()
  Base.Ctor(self)
end

local GroupName = "ShadingQuality"

function DebugTabShading:SetupTabs()
