...
local MagicReplayShowPlayerAndPetAction = Base:Extend("MagicReplayShowPlayerAndPetAction")
FsmUtils.MergeMembers(Base, MagicReplayShowPlayerAndPetAction, {})

function MagicReplayShowPlayerAndPetAction:Ctor(name, properties)
  Base.Ctor(self, name, properties)
end

function MagicReplayShowPlayerAndPetAction:OnEnter()
  ...
  _G.NRCModuleManager:DoCmd(_G.NPCModuleCmd.ShowOwnPetByPlayerId, self.localPlayerId, true, NPCModuleEnum.NpcReasonFlags.MAGIC_REPLAY)
  _G.NRCModuleManager:DoCmd(_G.FriendModuleCmd.OnCmdSwitchChatBubbles, self.localPlayer.viewObj, true)
...
return MagicReplayShowPlayerAndPetAction
