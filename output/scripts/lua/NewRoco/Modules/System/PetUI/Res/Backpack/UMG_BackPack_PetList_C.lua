...
local UMG_BackPack_PetList_C = Base:Extend("UMG_BackPack_PetList_C")

function UMG_BackPack_PetList_C:OnConstruct()
end

function UMG_BackPack_PetList_C:OnDestruct()
end

function UMG_BackPack_PetList_C:OnItemUpdate(_data, datalist, index)
  self.uiData = _data
  self.index = index
  self:UpdateItemInfo()
end

function UMG_BackPack_PetList_C:UpdateItemInfo()
  ...
  local addTxt = string.format(LuaText.pet_attribute_quantity, self.uiData.attrInfo.talent)
  ...
  local petBaseConf = _G.DataConfigManager:GetPetbaseConf(self.uiData.petConfId)
...
function UMG_BackPack_PetList_C:OnItemSelected(_bSelected)
end

function UMG_BackPack_PetList_C:OnDeactive()
end

return UMG_BackPack_PetList_C
