...
local UMG_PetDropDownList_C = _G.NRCPanelBase:Extend("UMG_PetDropDownList_C")

function UMG_PetDropDownList_C:OnConstruct()
  self.uidata = nil
  ...
  for i, v in pairs(cfgDatas) do
    table.insert(self.DefaultSort, {data = v, panel = nil})
  end
  ...
  self.TypeList = {}
  self.ConfirmBtn:SetBtnText(LuaText.umg_petdropdownlist_1)
...
function UMG_PetDropDownList_C:OnDestruct()
end

function UMG_PetDropDownList_C:OnAddEventListener()
...
function UMG_PetDropDownList_C:OnSelectedBtnClick()
...
function UMG_PetDropDownList_C:SetConfirmBtnEnable(bEnable)
  if bEnable then
...
function UMG_PetDropDownList_C:OnFilterBtnClicked()
...
function UMG_PetDropDownList_C:OnConfirmBtnClicked()
...
function UMG_PetDropDownList_C:OnBtn_Global()
  self:IsCloseMask(true)
  self:SetScrollVisible(false)
  self:SetFilterListVisible(false)
end

function UMG_PetDropDownList_C:IsCloseMask(_IsClose)
...
function UMG_PetDropDownList_C:SetReversedSort()
  self.IsReversedSort = false
end

function UMG_PetDropDownList_C:OnNRCButton_0Click()
  self:OnBtn_Global()
...
function UMG_PetDropDownList_C:OnActive(_index)
  self.uidata = nil
...
function UMG_PetDropDownList_C:SetScrollVisible(visible)
...
function UMG_PetDropDownList_C:SetFilterListVisible(bVisible)
...
function UMG_PetDropDownList_C:SetDeptList()
...
function UMG_PetDropDownList_C:UpdateDeptList(chooseTypeList)
...
function UMG_PetDropDownList_C:SelectTypeUpdate()
...
function UMG_PetDropDownList_C:SetDropDownListInfo(data)
...
function UMG_PetDropDownList_C:SetFilterListInfo(data)
  self.FilterList:InitGridView(data)
end

function UMG_PetDropDownList_C:SelectItem(sortType)
  self:SetScrollVisible(false)
  local selected = {}
...
function UMG_PetDropDownList_C:GetbListVisible()
  return self.bListVisible
end

function UMG_PetDropDownList_C:OnDeactive()
end

return UMG_PetDropDownList_C
