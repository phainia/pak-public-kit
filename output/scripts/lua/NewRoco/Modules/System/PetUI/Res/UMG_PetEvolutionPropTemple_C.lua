local UMG_PetEvolutionPropTemple_C = NRCUmgClass:Extend("UMG_PetEvolutionPropTemple_C")

function UMG_PetEvolutionPropTemple_C:Construct()
end

function UMG_PetEvolutionPropTemple_C:Destruct()
  NRCUmgClass.Destruct(self)
  self.uiData = nil
end

function UMG_PetEvolutionPropTemple_C:SetTitle(_title)
  self.textTitle:SetText(_title or "")
end

function UMG_PetEvolutionPropTemple_C:SetProp(_value1, _value2)
...
function UMG_PetEvolutionPropTemple_C:setActive(_uiItem, _isShow)
  if _uiItem then
    if _isShow then
...
return UMG_PetEvolutionPropTemple_C
