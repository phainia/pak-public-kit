...
local UMG_Pet_PartnerMarker_Item1_C = Base:Extend("UMG_Pet_PartnerMarker_Item1_C")

function UMG_Pet_PartnerMarker_Item1_C:OnConstruct()
end

function UMG_Pet_PartnerMarker_Item1_C:OnDestruct()
end

function UMG_Pet_PartnerMarker_Item1_C:OnItemUpdate(_data, datalist, index)
  self.uiData = _data
...
function UMG_Pet_PartnerMarker_Item1_C:OnItemSelected(_bSelected)
  if _bSelected then
...
function UMG_Pet_PartnerMarker_Item1_C:OnDeactive()
end

return UMG_Pet_PartnerMarker_Item1_C
