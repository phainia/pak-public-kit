...
local UMG_PetSkillIcon_C = Base:Extend("UMG_PetSkillIcon_C")

function UMG_PetSkillIcon_C:OnConstruct()
end

function UMG_PetSkillIcon_C:OnDestruct()
  self.btnItemIcon.OnClicked:Remove(self, self.OnBtnItemIconClick)
end

function UMG_PetSkillIcon_C:OnActive()
end

function UMG_PetSkillIcon_C:OnItemUpdate(_data, datalist, index)
  self.index = index
  self.uiData = _data
...
function UMG_PetSkillIcon_C:OnAddEventListener()
  self.btnItemIcon.OnClicked:Add(self, self.OnBtnItemIconClick)
end

function UMG_PetSkillIcon_C:SetPetNeedItemInfo()
  ...
  local itemCount = self.uiData.BagNum or 0
  ...
  if _data.CanSynthesize then
    self.CanSynthesize:SetVisibility(UE4.ESlateVisibility.SelfHitTestInvisible)
  else
    self.CanSynthesize:SetVisibility(UE4.ESlateVisibility.Collapsed)
  end
end

function UMG_PetSkillIcon_C:SetQuality(quality)
  if 0 == quality then
...
function UMG_PetSkillIcon_C:ClearSelectAnim()
...
function UMG_PetSkillIcon_C:txtFinishInfo()
  self.txtFinish:SetVisibility(UE4.ESlateVisibility.Visible)
  self.Panel_Count:SetVisibility(UE4.ESlateVisibility.Hidden)
end

function UMG_PetSkillIcon_C:OnBtnItemIconClick()
...
function UMG_PetSkillIcon_C:OnDeactive()
end

return UMG_PetSkillIcon_C
