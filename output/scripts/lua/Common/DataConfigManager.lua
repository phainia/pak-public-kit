...
function DataConfigManager:InitTableInfo()
  local configTableId = {
    ...
    SET_ROLE_ANIMATION_CONF = 13,
    ACTIVITY_COMMON_SHOW_CONF = 14,
    ACTIVITY_CONDITION_GROUP_CONF = 15,
    ACTIVITY_CONDITION_REWARD_CONF = 16,
    ACTIVITY_CONF = 17,
    ACTIVITY_DROP_CONF = 18,
    ACTIVITY_DROP_METHOD_CONF = 19,
    ACTIVITY_FACTION_CONF = 20,
    ACTIVITY_FLOWER_APPEAR_CONF = 21,
    ACTIVITY_FLOWER_TASK_CONF = 22,
    ACTIVITY_GOODS_CONF = 23,
    ACTIVITY_INHERITANCE_CONF = 24,
    ACTIVITY_INVITE_REGISTER_CONF = 25,
    ACTIVITY_MAINTAB_CONF = 26,
    ACTIVITY_MIX_CONF = 27,
    ACTIVITY_PET_CATCH_CONF = 28,
    ACTIVITY_PET_CERTIFICATION = 29,
    ACTIVITY_PET_COLLECTION_CONF = 30,
    ACTIVITY_PET_PARTNER_CONF = 31,
    ACTIVITY_PET_PHOTO = 32,
    ACTIVITY_PET_RAISE_CONF = 33,
    ACTIVITY_PET_RAISE_TASK_CONF = 34,
    ACTIVITY_PET_TRIP_CONF = 35,
    ACTIVITY_PIKA_CONF = 36,
    ACTIVITY_PLAYER_CO_CREATION = 37,
    ACTIVITY_PREHEAT_CONF = 38,
    ACTIVITY_RELAY_PAGE = 39,
    ACTIVITY_REWARD_BY_STAGE_CONF = 40,
    ACTIVITY_SHINY_WEEKEND_CONF = 41,
    ACTIVITY_SHOP_CONF = 42,
    ACTIVITY_SPECIAL_CONF = 43,
    ACTIVITY_SPEC_FLOWER_SEED_CONF = 44,
    ACTIVITY_SPRING_FESTIVAL_CONF = 45,
    ACTIVITY_TLOG_CONF = 46,
    ACTIVITY_TRACK_CONDITION_CONF = 47,
    ACTIVITY_TREASURE_HUNT_CONF = 48,
    ACTIVITY_UP_CONF = 49,
    ACTIVITY_WEBSITE_PART_CONF = 50,
    ACTIVITY_WEEKEND_CHALLENGE_CONF = 51,
    ACTIVITY_WISH_LOTTER_AWARD = 52,
    ACT_LIMITTIME_APPEAR = 53,
    BOSS_CHALLENGE_EVENT_CONF = 54,
    LEGENDARY_BATTLE_EVENT = 55,
    LEGENDARY_CHALLENGE_CONF = 56,
    NPC_CHALLENGE_EVENT_CONF = 57,
    SECONDARY_TAB_CONF = 58,
    TAKEPHOTO_COMPETITION_CONF = 59,
    TERRITORY_TRIAL_CONF = 60,
    WEEKEND_CHALLENGE_GROUP_CONF = 61,
    WEEKLY_CHALLENGE_EVENT_CONF = 62,
    ACTIVITY_OPTION_CONF = 63,
    ACTIVITY_SPECIAL_TXT_CONF = 64,
    ACTIVITY_TASK_GO_CONF = 65,
    SPEC_BATTLE_UI = 66,
    ACTIVITY_GLOBAL_CHALLENGE = 67,
    ACTIVITY_GLOBAL_CHALLENGE_SIGN = 68,
    ACTIVITY_PET_TRIP_RULE = 69,
    ACTIVITY_SIGN_REWARD = 70,
    ACTIVITY_STAGE_REWARD_CONF = 71,
    PET_INFORMATION_CONF = 72,
    PRE_DOWNLOAD_CONF = 73,
    ACTIVITY_RECALLBP_CONF = 74,
    ACTIVITY_RECALL_CLASS_CONF = 75,
    ACTIVITY_RECALL_CONF = 76,
    ACTIVITY_RECALL_PET_CONF = 77,
    ACTIVITY_RECALL_STARLIGHTBUFF = 78,
    ACTIVITY_UMG_RULE_CONF = 79,
    COMPETITION_RULE_CONF = 80,
    CONTESTANT_REWARD_CONF = 81,
    JUDGE_REWARD_CONF = 82,
    ADVENTURE_CONF = 83,
    DAILY_TASK_REWARD_CONF = 84,
    REGION_CONF = 85,
    AI_BATTLE_RESULT_BEHAVIOR = 86,
    AI_BATTLE_RESULT_CONF = 87,
    NRC_AI_BB_INITIATE_CONF = 88,
    NRC_AI_BB_INPUT_CONF = 89,
    NRC_AI_BB_INSTANCE_CONF = 90,
    NRC_AI_BB_NAME_DEFINE_CONF = 91,
    NRC_AI_BEHAVIOR_CONF = 92,
    NRC_AI_BEHAVIOR_GROUP_CONF = 93,
    NRC_AI_CONE_MODER_CONF = 94,
    NRC_AI_FSM_COND_CONF = 95,
    NRC_AI_FSM_STATE_CONF = 96,
    NRC_AI_FSM_STRUCTURE_CONF = 97,
    NRC_AI_GAMEPLAY_STATETRANS_CONF = 98,
    NRC_AI_GAMEPLAY_STATE_CONF = 99,
    NRC_AI_GAMEPLAY_TAG_CONF = 100,
    NRC_AI_GLOBAL_CONFIG_CONF = 101,
    NRC_AI_GROUP_INFO_CONF = 102,
    NRC_AI_MUTUAL_EXCLUSION_CONF = 103,
    NRC_AI_OVERWRITE_BEHAVIOR_CONF = 104,
    NRC_AI_PERCEPTION_AUDIO_CONF = 105,
    NRC_AI_PERCEPTION_MODER_CONF = 106,
    NRC_AI_PERCEPTION_VISUAL_CONF = 107,
    NRC_AI_PERFORM_POOL_CONF = 108,
    NRC_AI_PERFORM_SKILL_CONF = 109,
    NRC_AI_RELATION_SCHEMA_CONF = 110,
    NRC_AI_SENSE_CONE_CONF = 111,
    NRC_AI_SENSE_EVENT_CONF = 112,
    NRC_AI_WORLD_COMBAT_SKILL_CONF = 113,
    NRC_AI_WORLD_EVENT_CONF = 114,
    NRC_GROUP_AI_BASIC_INFO_CONF = 115,
    NRC_GROUP_AI_BEHAVIOR_CONF = 116,
    NRC_GROUP_AI_DISMISS_CONF = 117,
    NRC_GROUP_AI_DYNAMIC_EVENT_CONF = 118,
    NRC_GROUP_AI_EVENT_CONF = 119,
    NRC_GROUP_AI_MOVE_CONF = 120,
    NRC_GROUP_AI_ROLE_TYPE_CONF = 121,
    NRC_GROUP_AI_STATION_CONF = 122,
    NRC_HOME_AI_CONF = 123,
    ALL_RIDE_PET = 124,
    ALL_RIDE_UI_CONF = 125,
    RIDE_ANIMATION = 126,
    RIDE_BASIC_MOVEMENT = 127,
    RIDE_EFFECTS = 128,
    RIDE_PASSIVE_SKILL = 129,
    RIDE_SOCKET = 130,
    RIDE_SOCKET_EXPORT = 131,
    ANIM_CONF = 132,
    ANIM_ID_CONF = 133,
    ANIM_MOTION_CURVE_CONF = 134,
    AREA_CHECK_CONF = 135,
    AREA_CONF = 136,
    AREA_FUNC_CONF = 137,
    AREA_GROUP_CONF = 138,
    AREA_SCENEOBJ_CONF = 139,
    AREA_TAG_CONF = 140,
    AREA_TRIG_CONF = 141,
    AREA_UI_CONF = 142,
    AREA_VISIBLE_CONF = 143,
    AREA_WEATHER_CONF = 144,
    AUDIO_CAVE_CONF = 145,
    AUDIO_FUBEN_CONF = 146,
    AUDIO_LENGTH_CONF = 147,
    AUDIO_MODEL_CONF = 148,
    AUDIO_NATURE_CONF = 149,
    PET_HOME_LIMIT_CONF = 150,
    PET_NAME_MAP_CONF = 151,
    BATTLE_USED_BY_TASK_CONF = 152,
    DIALOGUE_ONLY_OPTION_CONF = 153,
    DIALOGUE_USED_BY_TASK_CONF = 154,
    FUNCTION_BAN_SPECIAL_NPC_CONF = 155,
    HABITAT_CONF = 156,
    HOME_USED_BY_TASK_CONF = 157,
    MOVIE_USED_BY_TASK_CONF = 158,
    OPTION_USED_BY_TASK_CONF = 159,
    PETBASE_USED_BY_FASHION_BOND = 160,
    SEQUENCE_USED_BY_TASK_CONF = 161,
    BAG_ITEM_CONF = 162,
    BAG_ITEM_SEQUENCE = 163,
    BAG_ITEM_TYPE_CONF = 164,
    BAG_PET_GIFT_EFFECT_CONF = 165,
    BATTLE_ITEM_CONF = 166,
    ITEM_LABLE_TYPE_CONF = 167,
    PET_CARRYON_ITEM = 168,
    PET_CARRYON_UPGRADE = 169,
    PLAYER_MAGIC_CONF = 170,
    THROW_FUNC_CONF = 171,
    BALL_ACT = 172,
    BALL_CONF = 173,
    BALL_FORBID_CAPTURE = 174,
    AI_MODEL_WARM_CONF = 175,
    AONE_FINAL_BATTLE_PETSLIST_CONF = 176,
    BATTLE_CONF = 177,
    BATTLE_RULE_CONF = 178,
    BATTLE_TYPE_CONF = 179,
    BATTLE_PASS_CONF = 180,
    BATTLE_PASS_GIFT_CONF = 181,
    BATTLE_PASS_REWARD_CONF = 182,
    BATTLE_PASS_TASK_MODULE_CONF = 183,
    BATTLE_PASS_THEME_CONF = 184,
    BATTLE_PASS_UI_COLOR = 185,
    BATTLE_PASS_UI_THEME = 186,
    BATTLE_GUIDE_CONF = 187,
    COMBAT_MECHANISM_BATTLE_CONF = 188,
    COMBAT_MECHANISM_TEACH_CONF = 189,
    TYPE_ADVANTAGE_BATTLE_CONF = 190,
    TYPE_ADVANTAGE_TEACH_CONF = 191,
    BEHAVIOR_CONF = 192,
    BST_CONF = 193,
    WORLD_BUFF_CONF = 194,
    CAMERA_CONF = 195,
    CAMERA_MOVE_LITE = 196,
    CAMERA_PATH = 197,
    CAMP_CONF = 198,
    CAMP_CONTENT_NPC_CONF = 199,
    CAMP_LEVELUP_CONF = 200,
    CAMP_PET_REPORT_CONF = 201,
    PET_FRUIT_CONF = 202,
    PET_SETTLED_BONUS_CONF = 203,
    REPORT_COIN_RATIO_CONF = 204,
    TRAVEL_SEQUENCE_CONF = 205,
    BOSS_CHALLENGE_CONF = 206,
    CHEER_POINT_CONF = 207,
    NPC_CHALLENGE_CONF = 208,
    TERRITORY_TRIAL_CHALLENGE_CONF = 209,
    WEEKLY_CHALLENGE_CONF = 210,
    WEEKLY_PHOTO_CONF = 211,
    CHAT_EMOJI_CONF = 212,
    CLIENT_PUBLIC_CMD = 213,
    CLIMB_CHAPTER_CONF = 214,
    STAGE_CONF = 215,
    COLLEGE_SELECTION_CONF = 216,
    TASK_DATA_GUARD_CONF = 217,
    ACTION_RESULT_TYPE_CONF = 218,
    CUSTOMCAMERA_CONF = 219,
    DIALOGUE_CONF = 220,
    DIALOGUE_ORDER_CONF = 221,
    FUNCTION_STORY_FLAG_CONF = 222,
    PERFORM_CONF = 223,
    SELECT_CONF = 224,
    DUNGEON_CONF = 225,
    DUNGEON_STAGE = 226,
    IMPORTANT_HIGH_VALUE_CONF = 227,
    IMPORTANT_ITEM_CONF = 228,
    IMPORTANT_OUTPUT_PATH_CONF = 229,
    IMPORTANT_PET_MUTATION_CONF = 230,
    EMOTION_CONF = 231,
    ITEM_UNLOCK_MAP_CONF = 232,
    EXCHANGE_CONF = 233,
    EXCHANGE_GOODS_CONF = 234,
    EXCHANGE_TIME_LIMIT_CONF = 235,
    WISH_EXCHANGE_CONF = 236,
    BOND_TAB_CONF = 237,
    BOND_TINT_CONF = 238,
    CHANGE_COLOUR_CONF = 239,
    CLOSET_TAB_CONF = 240,
    FASHION_BAGCHARM_CONF = 241,
    FASHION_BOND_CONF = 242,
    FASHION_CONFLICTTAG_CONF = 243,
    FASHION_DRESSFORM_CONF = 244,
    FASHION_ITEM_CONF = 245,
    FASHION_PACKAGE_CONF = 246,
    FASHION_PERFORM_CONF = 247,
    FASHION_SUITS_CONF = 248,
    FASHION_TAB_CONF = 249,
    FASHION_VI_CONF = 250,
    FASHION_WAND_CONF = 251,
    HEADWEAR_HAIR_CONF = 252,
    HEADWEAR_OFFSET_CONF = 253,
    HEADWEAR_TYPE_CONF = 254,
    ITEM_TRANS_CONF = 255,
    PRIVILEGE_RIDE_CONF = 256,
    PRIVILEGE_WAND_CONF = 257,
    SALON_ITEM_CONF = 258,
    SALON_TAB_CONF = 259,
    FIX_DATA_EVOLUTION_ERROR = 260,
    EXCHANGE_NORMAL_FILTER_CONF = 261,
    HANDBOOK_FILTER_CONF = 262,
    HOME_FILTER_CONF = 263,
    PET_FILTER_CONF = 264,
    SKILLMACHINE_FILTER_CONF = 265,
    SKILL_FILTER_CONF = 266,
    TRAVEL_FILTER_CONF = 267,
    NPC_FOLLOW_CONF = 268,
    NPC_FOLLOW_TALK_CONF = 269,
    FRIEND_RECOMMEND_CONF = 270,
    BAN_ACTION_CONF = 271,
    BAN_NPC_CONF = 272,
    FUNCTION_BAN_CONF = 273,
    FUNCTION_BAN_SCENE_RES_CONF = 274,
    HIDE_PLAYER_MANUAL_OPTION_CONF = 275,
    SYSTEM_RED_POINT_BAN_CONF = 276,
    UI_BAN_CONF = 277,
    UI_ENTER_BAN_CONF = 278,
    COLOR_RANDOM_CONF = 279,
    GLASS_TYPE_CONF = 280,
    HIDDEN_GLASS_CONF = 281,
    PARTICLE_RANDOM_CONF = 282,
    ACTIVITY_GLOBAL_CONFIG = 283,
    ANTI_CHEAT_GLOBAL_CONFIG = 284,
    ATTR_GLOBAL_CONFIG = 285,
    BATTLE_GLOBAL_CONFIG = 286,
    BP_GLOBAL_CONFIG = 287,
    CHALLENGE_GLOBAL_CONF = 288,
    DAILY_GLOBAL_CONFIG = 289,
    FRIEND_GLOBAL_CONFIG = 290,
    GLOBAL_CONFIG = 291,
    HOME_GLOBAL_CONFIG = 292,
    LEGENDARY_GLOBAL_CONFIG = 293,
    LLM_GLOBAL_CONFIG = 294,
    MAP_GLOBAL_CONFIG = 295,
    NPC_GLOBAL_CONFIG = 296,
    ONLINE_GLOBAL_CONFIG = 297,
    PAYMENT_GLOBAL_CONFIG = 298,
    PET_GLOBAL_CONFIG = 299,
    ROGUE_CHALLENGE_GLOBAL_CONFIG = 300,
    ROLE_GLOBAL_CONFIG = 301,
    SEASON_GLOBAL_CONFIG = 302,
    TAKEPHOTO_GLOBAL_CONFIG = 303,
    TASK_GLOBAL_CONFIG = 304,
    GM_AI_GROUP_CONF = 305,
    GM_BUTTON_CONF = 306,
    GM_COMMAND_CONF = 307,
    GM_GROUP_CONF = 308,
    GM_MAINTAB_CONF = 309,
    GM_SERVER_CMD_CONF = 310,
    GM_SUBTAB_CONF = 311,
    GRASS_TRIAL_CHAPTER_CONF = 312,
    GRASS_TRIAL_CONF = 313,
    GRASS_TRIAL_EFFECT_CONF = 314,
    GRASS_TRIAL_EVENT_CONF = 315,
    GUIDE_ANIMATION_IGNORE_CONF = 316,
    GUIDE_BANNER_CONF = 317,
    GUIDE_BUTTON_CONF = 318,
    GUIDE_CTRL_CONF = 319,
    GUIDE_DRAG_CONF = 320,
    GUIDE_FOCUS_CONF = 321,
    GUIDE_IA_CONF = 322,
    GUIDE_PANEL_CONF = 323,
    HINT_LEVEL = 324,
    FURNITURE_CLASSIFICATION_CONF = 325,
    FURNITURE_EFFECT_CONF = 326,
    FURNITURE_HANDBOOK_CONF = 327,
    FURNITURE_ITEM_CONF = 328,
    FURNITURE_VERSION_CONF = 329,
    HOME_COMFORT_CONF = 330,
    HOME_LEVEL_CONF = 331,
    HOME_PET_FEED_CONF = 332,
    HOME_PET_LAY_EGG_RATE_CONF = 333,
    INTERIOR_FINISH_CONF = 334,
    PLANT_GROW_CONF = 335,
    PLANT_GROW_STAGE_CONF = 336,
    PLANT_LAND_COORDINATE_CONF = 337,
    PLANT_TAB_CONF = 338,
    ROOM_CONF = 339,
    IOS_RATING_POPUP_CONF = 340,
    LINE_CONF = 341,
    LLM_PET_BEHAVIOR_CONF = 342,
    LLM_PET_NATURE_CONF = 343,
    LOADING_TIPS_CONF = 344,
    PVP_MATCH_TIPS_CONF = 345,
    LOCALIZATION_CONF = 346,
    SUB_EVENTS_CONF = 347,
    SUB_TPLS_CONF = 348,
    ALL_DIALOGUE_EN = 349,
    TASK_DIALOGUE_EN = 350,
    LOTTERY_RESULT_PAGE_CONF = 351,
    LOTTERY_REWARD_CONF = 352,
    MAGE_CONF = 353,
    MAGE_HELP_CONF = 354,
    MAGE_INFO_CONF = 355,
    MAGE_REST_CONF = 356,
    MAGIC_BASE_CONF = 357,
    MAGIC_INTERACT_CONF = 358,
    MAGIC_TRANSFORM_CONF = 359,
    STAR_MAGIC_CONF = 360,
    CALLBACK_MAIL_CONF = 361,
    MAIL_CONF = 362,
    NOTICE_CONF = 363,
    MALL_CONF = 364,
    MALL_RAND_CONF = 365,
    MALL_STORE_CONF = 366,
    MARK_FAKE_MAGIC_MESSAGE_CONF = 367,
    MARK_GAMEPLAY_CONF = 368,
    MARK_MESSAGE_CHILD_CONF = 369,
    MARK_MESSAGE_LIFE_TIME_CONF = 370,
    MARK_VIDEO_PROTOCOL = 371,
    MEDAL_BOND_CONF = 372,
    MEDAL_CONF = 373,
    MEDAL_TASK_CONF = 374,
    TEXT_EXP_CONF = 375,
    MEGAMAP_CLASS_NAME_CONF = 376,
    MEGAMAP_CONF = 377,
    MEGAMAP_GATHERING_CONF = 378,
    MEGAMAP_MAP_CONF = 379,
    MEGAMAP_OVERLAP_CONF = 380,
    MEGAMAP_REFRESH_BLACKLIST = 381,
    MEGAMAP_SPEED_CONF = 382,
    MINIGAME_CONF = 383,
    MINIGAME_RULE_CONF = 384,
    MODEL_COLLISION_CONF = 385,
    MODEL_CONF = 386,
    MODEL_MAT_CONF = 387,
    MODEL_SOCKET_CONF = 388,
    BLOOD_MONSTER_SKILLBANK_CONF = 389,
    CATCH_CONDITION_CONF = 390,
    ESCAPE_INFO_CONF = 391,
    MONSTER_CATCH_CONF = 392,
    MONSTER_CONF = 393,
    MONSTER_GROWTH_CONF = 394,
    MONSTER_SKILLBANK_CONF = 395,
    SPECIAL_MOVE_CONF = 396,
    MUSIC_APPLY_LIST_CONF = 397,
    MUSIC_CONF = 398,
    MUSIC_FREEMIUM_CONF = 399,
    MUSIC_TYPE_CONF = 400,
    NIGHTMARE_ELITE_CONF = 401,
    SEASON_ELITE_CONF = 402,
    AI_WORD_CONF = 403,
    BATTLE_RANDOM_CONF = 404,
    LOCATION_INTERACT_BAN = 405,
    NPC_ACTION_CONF = 406,
    NPC_ACTOR_POOL_CONF = 407,
    NPC_AURA_CONF = 408,
    NPC_AURA_EFFECT_CONF = 409,
    NPC_COMPASS_OPTION = 410,
    NPC_CONF = 411,
    NPC_OPTION_CONF = 412,
    NPC_PEER_CONF = 413,
    NPC_REACTION_CONF = 414,
    PET_INTERACTION_COMPLEX = 415,
    PET_INTERACTION_CONF = 416,
    TASK_NPC = 417,
    NPC_COMB_OPTION_CONF = 418,
    NPC_COMB_RESULT_CONF = 419,
    NPC_PENDANT_CONF = 420,
    BONUS_CONTAINER_CONF = 421,
    BONUS_EVENT_POOL_CONF = 422,
    BONUS_SHINING_STG_CONF = 423,
    BONUS_SPE_EVENT_POOL_CONF = 424,
    NPC_REFRESH_BONUS_CONF = 425,
    NPC_REFRESH_CONTENT_CONF = 426,
    NPC_REFRESH_GROUP_CONF = 427,
    NPC_REFRESH_RULE_CONF = 428,
    NPC_REFRESH_TIME_CONF = 429,
    NPC_SERVER_REFRESH_CONF = 430,
    REFRESH_COND_CONF = 431,
    WEIGHT_GROUP_CONF = 432,
    OPERATION_MAIL = 433,
    OWL_CONTENT_NPC_CONF = 434,
    OWL_PET_FRUIT_CONF = 435,
    OWL_SANCTUARY_CONF = 436,
    PARAGRAPH_PACKAGE_ORDER_CONF = 437,
    PARAGRAPH_VO_CONF = 438,
    AREA_HANDBOOK = 439,
    BASE_POINT_CONF = 440,
    BREAK_ITEM_CONF = 441,
    BREAK_NUMBER_CONF = 442,
    BREAK_REWARD_CONF = 443,
    CRYSTAL_CONF = 444,
    EGG_TYPE_CONF = 445,
    EVOLUTION_ACTION_DATA = 446,
    EVOLUTION_LEVEL_DATA = 447,
    GROW_LEVEL_CONF = 448,
    INSPIRE_LEVEL_CONF = 449,
    LEVEL_GET_FIX_CONF = 450,
    LEVEL_SKILL_CONF = 451,
    NATURE_CONF = 452,
    OVERLEVEL_RATIO_EXP = 453,
    PETBASE_CONF = 454,
    PETFREE_CONF = 455,
    PETPAGE_BLACKLIST = 456,
    PET_ACTION_CLOSE_EXP_CONF = 457,
    PET_BAG_SEQUENCE = 458,
    PET_BLOOD_CONF = 459,
    PET_BOND = 460,
    PET_BOND_COUNT = 461,
    PET_CLASSIS_CONF = 462,
    PET_CLOSE_LEVEL_EFFECT_CONF = 463,
    PET_CONF = 464,
    PET_EFFORTS_LEVEL = 465,
    PET_EGG_CONF = 466,
    PET_EGG_WAY_TO_PROB_CONF = 467,
    PET_EVOLUTION_CONF = 468,
    PET_FEATURE_RAND = 469,
    PET_FREE_REWARD_CONF = 470,
    PET_HABIT_CONF = 471,
    PET_HANDBOOK = 472,
    PET_HANDBOOK_REWARD = 473,
    PET_HANDBOOK_SEQUENCE = 474,
    PET_LEVEL_CONF = 475,
    PET_LIKE_ELEMENT_CONF = 476,
    PET_MARK_CONF = 477,
    PET_REPORT_SCORE_CONF = 478,
    PET_SCENE_ABILITY_GANZHI = 479,
    PET_SHOW_SPEED_CONF = 480,
    PET_TALENT_CONF = 481,
    PET_TALENT_RANDOM_CONF = 482,
    PET_TOPIC_TYPE_CONF = 483,
    PET_UI_CAMERA_CONF = 484,
    SEASON_HANDBOOK_CONF = 485,
    SKILL_COLOR_CONF = 486,
    SKILL_RANDOM_CONF = 487,
    SKILL_SEQUENCE_CONF = 488,
    SUBMIT_PET_CONF = 489,
    UNCOMMAND_PET_SKILL_CONF = 490,
    PET_INFO_CONF = 491,
    PET_RANDOM_EGG_CONF = 492,
    PET_PARTNER_DATA = 493,
    PET_ROLLBACK_CONF = 494,
    POINT_CONF = 495,
    PLATFORM_PRIVILEGES = 496,
    PROTO_CMD_SEQ_CONF = 497,
    PET_TYPE_SCORE_CONF = 498,
    PVP_AWARD_CONF = 499,
    PVP_BATTLE_SCORE_CONF = 500,
    PVP_CONF = 501,
    PVP_RANDOM_PET_LIBRARY_CONF = 502,
    PVP_RANDOM_PET_REWARD_CONF = 503,
    PVP_RANDOM_SKILL_LIBRARY_CONF = 504,
    PVP_RANDOM_SKILL_LIST_CONF = 505,
    PVP_RANK_CONF = 506,
    PVP_RANK_PLAYER_POLL_CONF = 507,
    PVP_RANK_RANDOM_PET_CONF = 508,
    PVP_RANK_ROBOT_CARD_ICON_CONF = 509,
    PVP_RANK_ROBOT_NAME_CONF = 510,
    PVP_RANK_ROBOT_PLAYER_CONF = 511,
    PVP_RANK_SEASON_CONF = 512,
    PVP_RANK_TRIAL_PET_CONF = 513,
    PVP_RANK_TRIAL_PET_LIBRARY_CONF = 514,
    PVP_RANK_WEEK_TASK_CONF = 515,
    PVP_ROBOT_CONF = 516,
    PVP_WAREHOUSE_CONF = 517,
    TOP_MASTER_CONF = 518,
    RANKBOARD_CONF = 519,
    READ_CONF = 520,
    REACALL_CONF = 521,
    REACALL_LIST_CONF = 522,
    REACALL_TREMS_CONF = 523,
    RED_POINT_CONF = 524,
    INTERACTIONTREE_CONF = 525,
    RELATIONTREE_ANIM_CONF = 526,
    RELATIONTREE_BASIC_CONF = 527,
    RELATIONTREE_CONF = 528,
    RESOURCE_CONF = 529,
    LOTTERY_POOL_CONF = 530,
    LOTTERY_POOL_REWARD_CONF = 531,
    REWARD_CONF = 532,
    REWARD_TAG = 533,
    REWARD_WEIGHT_CHANGE_CONF = 534,
    EVENT_BASE_CONF = 535,
    EVENT_COMBINE_CONF = 536,
    ROGUE_LEVEL_CONF = 537,
    UPGRADE_CONF = 538,
    BOTTLE_TIMES_CONF = 539,
    BOTTLE_VOLUME_CONF = 540,
    HP_MAX_CONF = 541,
    POWER_MAX_CONF = 542,
    ROLE_EXP_CONF = 543,
    ROLE_STAR_NPCLEVEL_CHANGE_CONF = 544,
    ROLE_WORLD_LEVEL_MAP_CONF = 545,
    WORLD_LEVEL_CONF = 546,
    CARD_ADVENTURE_RECORD_CONF = 547,
    CARD_ICON_CONF = 548,
    CARD_LABEL_CONF = 549,
    CARD_MODULE_CONF = 550,
    CARD_SKIN_CONF = 551,
    EQS_BOX_EXPORT = 552,
    PET_BEHAVIOR_REACTION_CONF = 553,
    ROLEPLAY_BEHAVIOR_CONF = 554,
    ROLEPLAY_PROP_CONF = 555,
    ROLEPLAY_SORT_CONF = 556,
    SCENE_AWARD_CONF = 557,
    SCENE_CONF = 558,
    SCENE_OBJECT_AWARD = 559,
    SCENE_OBJECT_CONF = 560,
    SCENE_RES_CONF = 561,
    SCENE_UPGRADE_VERSION_CONF = 562,
    SCENE_ABILITY_ASCENDING_CONF = 563,
    SCENE_ABILITY_CONF = 564,
    SCENE_ABILITY_DASH_CONF = 565,
    SCENE_ABILITY_FLYING_CONF = 566,
    SCENE_ABILITY_RIDING_CONF = 567,
    SCENE_ABILITY_SLIDING_CONF = 568,
    SCENE_ABILITY_THROW_CONF = 569,
    SCENE_PLAYER_STATUS_MATRIX = 570,
    VITALITY_CONF = 571,
    SCENE_EFFECT_CONF = 572,
    ABNORMAL_STATUS_CONF = 573,
    SCENE_STATUS_SALS_CONF = 574,
    SCENE_STATUS_WPST_CONF = 575,
    SEASON_BATTLE_RULE_CONF = 576,
    SEASON_CONF = 577,
    SEASON_GROWTH_CONF = 578,
    SEASON_ITEM_CONF = 579,
    SEASON_LEGENDARY_BATTLE_EVENT = 580,
    SEASON_PART_CONF = 581,
    SEASON_PETBASE = 582,
    SEASON_PET_CATCH_REWARD_CONF = 583,
    SEASON_PVE_BASE_CONF = 584,
    SEASON_SKILL = 585,
    SEASON_TALENT_CONF = 586,
    SEASON_ADVENTURE_BADGE_LEVEL = 587,
    SEASON_ADVENTURE_CHAPTER = 588,
    SEASON_ADVENTURE_CONF = 589,
    SEASON_ADVENTURE_UI = 590,
    BONUSCATCH_REFRESH_RULE_CONF = 591,
    SEASON_BONUSCATCH_BOX_CONF = 592,
    SEASON_BONUSCATCH_EFFECTS_CONF = 593,
    SEASON_BONUSCATCH_LIMIT_CONF = 594,
    SEASON_BONUSCATCH_SEC_OPT_CONF = 595,
    SEASON_PET_EFFECTS_CONF = 596,
    SEASON_FOCUS_UMG_CONF = 597,
    SEASON_TIPS_NEW_PET_CONF = 598,
    SEASON_TIPS_PVP_CONF = 599,
    SEASON_TIPS_TAB_CONF = 600,
    SEASON_TIPS_TXT_CONF = 601,
    SEASON_TPT_COMMON_CONF = 602,
    SEAT_CONF = 603,
    SECOND_TIER_PASSWORD_CONF = 604,
    MOVIE_CONF = 605,
    SEQUENCE_CONF = 606,
    SUBTITLE_CONF = 607,
    RPC_LOSS_RATE_CONF = 608,
    BUTTON_SETTING_CONF = 609,
    DEFAULT_BUTTON_CONF = 610,
    RESOLUTION_CONF = 611,
    UI_KEYNAME_CONVERT = 612,
    PET_SHARE_ITEM_CONF = 613,
    QQ_ARK_SHARE_CONF = 614,
    SHARE_BASE_CONF = 615,
    SHARE_CONF = 616,
    SHARE_PART_CONF = 617,
    SHARE_REWARD_CONF = 618,
    GOODS_RETURN_CONF = 619,
    MALL_FRAME_CONF = 620,
    MALL_MONTHLY_PASS_REWARD = 621,
    NORMAL_SHOP_CONF = 622,
    RANDOM_GOODS_CONF = 623,
    RANDOM_SHOP_CONF = 624,
    SHOP_BAN_CONF = 625,
    SHOP_CONF = 626,
    SHOP_TOTAL_CONSUMPTION_CONF = 627,
    ATTRIBUTE_CONF = 628,
    BUFFBASE_CONF = 629,
    BUFF_CONF = 630,
    BUFF_TYPE = 631,
    DESC_NOTE_CONF = 632,
    EFFECT_ANIMATION = 633,
    EFFECT_CONF = 634,
    ENTERBATTLE_BUFF_PRIORITY = 635,
    FIELD_LAYER_CONF = 636,
    PREATTACK_SKILL = 637,
    RES_BGS_TIME_CONF = 638,
    RES_BUFF_TIME_CONF = 639,
    RES_SKILL_TIME_CONF = 640,
    SKILLFULLY_EXCHANGE_CONF = 641,
    SKILLSPECIAL_CONF = 642,
    SKILL_CONF = 643,
    SKILL_INTERACT_CONF = 644,
    SKILL_RES_CHANGE_CONF = 645,
    SKILL_RES_CONF = 646,
    SKILL_TAG = 647,
    SKILL_TIME_CONF = 648,
    SKILL_UI_DES = 649,
    ...
    BOTTLE_CONF = 652,
    FRUIT_TREE_CONF = 653,
    FRUIT_TREE_RULE_CONF = 654,
    WIND_GRASS = 655,
    SPLINE_CONF = 656,
    LEGENDARY_BATTLE_AWARD = 657,
    STAR_AWARD_CONF = 658,
    TEAM_BATTLE_AWARD = 659,
    ACTCONTROLCONFIG = 660,
    CHANNELCONTROLCONFIG = 661,
    SYSTEMCONTROLCONFIG = 662,
    CAMERA_SKIN_CONF = 663,
    TAKE_PHOTO_EMOJI_CONF = 664,
    TAKE_PHOTO_FILTER_CONF = 665,
    TAKE_PHOTO_POSE_CONF = 666,
    CHAPTER_CONF = 667,
    GP_CONTEST_CONF = 668,
    GUIDE_CONF = 669,
    MESSAGE_CONF = 670,
    ...
    STORY_BGM_CONF = 672,
    SUB_TASK_CONF = 673,
    TALE_BLOOD_MAGIC_CONF = 674,
    TALE_NIGHTMARE_CONF = 675,
    TALE_NOTEBOOK_KELI_CONF = 676,
    TASK_CONF = 677,
    TASK_ITEM = 678,
    TASK_MODULE_CONF = 679,
    TASK_PET_PARAM_CONF = 680,
    TASK_STATE_CONF = 681,
    TASK_STYLE_CONF = 682,
    TASK_SUMMARY = 683,
    TASK_SWITCH_CONF = 684,
    TASK_TOKEN_CONF = 685,
    TRACK_NUMBER = 686,
    UNIT_CONF = 687,
    TEACH_CONF = 688,
    TEACH_TAB_CONF = 689,
    SCENE_ENTER_EXIT = 690,
    TELEPORT_CONF = 691,
    TELEPORT_LOADING_CONF = 692,
    TELEPORT_RULES_CONF = 693,
    ENV_TAG_CONF = 694,
    TEST_RECHARGE_AMOUNT_CONF = 695,
    TITLE_CONF = 696,
    TREASURE_ITEM_CONF = 697,
    SPE_REFRESH_TRIG_CONF = 698,
    UI_COMPASS = 699,
    UI_CONF = 700,
    UI_LOBBY_MAIN_COMPASS = 701,
    UI_RECONNECT = 702,
    BALLTLEPASS_AWARDMAIN_CONF = 703,
    BATTLEPASS_PURCHASE_CONF = 704,
    UMG_DIALOG_CONF = 705,
    UMG_STATIC_CONF = 706,
    VIDEO_SUBTITLES_CONF = 707,
    VISUAL_ITEM_CONF = 708,
    PET_WAREHOUSE_CONF = 709,
    TIDY_SEQUENCE_TYPE = 710,
    WAREHOUSE_COLLECT_MARK = 711,
    WATER_MARK_CONTROL_CONF = 712,
    WATER_MARK_LOCALIZATION_CONF = 713,
    WATER_MARK_WHITE_LIST_CONF = 714,
    TOD_CONF = 715,
    WEATHER_CONF = 716,
    ACTION_ANIM_BONE_TRANSFORM_INFO = 717,
    BLOCK_CONF = 718,
    BOSS_SKILLS_MAP_CONF = 719,
    CURVE_DETAIL_INFO = 720,
    SKILL_ANIM_SOCKETS_INFO = 721,
    WEAKNESS_CONF = 722,
    WORLD_COMBAT_CONF = 723,
    WORLD_COMBAT_SKILL_CONF = 724,
    WORLD_COMBAT_SKILL_CURVE_CONF = 725,
    LAYERED_WORLD_MAP_CONF = 726,
    MAP_INFO_BAR_CONF = 727,
    WORLD_EXPLORING_STATISTIC_CONF = 728,
    WORLD_MAP_ACTIVITY_CONF = 729,
    WORLD_MAP_AREA_GUIDE = 730,
    WORLD_MAP_BLOCK_CONF = 731,
    WORLD_MAP_CHALLENGE_CONF = 732,
    WORLD_MAP_CONF = 733,
    WORLD_MAP_DEFAULT_TRACK = 734,
    WORLD_MAP_GLOBAL_CONF = 735,
    WORLD_MAP_SCALE_CONF = 736,
    WORLD_ZONE_CONF = 737,
    ZONE_EFFECT_CONF = 738
  }
...
function DataConfigManager:GetSetRoleAnimationConf(_id, _ignoreLog)
  return self:GetData(self.ConfigTableId.SET_ROLE_ANIMATION_CONF, _id, _ignoreLog)
end
