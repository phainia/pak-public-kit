    ...
    if userSetUseClib then
      if true == isUserSetClibPath then
        ...
        if "mac" == platform then
          strTable[#strTable + 1] = "\229\176\157\232\175\149\229\188\149\231\148\168arm\229\186\147: " .. armPath
...
function this.processExp(msgTable)
  ...
  elseif var.type == "string" and nil ~= retString then
    var.value = "\"" .. retString .. "\""
  end
  this.clearEnv()
  local retTab = {}
...
function tools.show(t, name, indent)
  ...
  local addtocart = function(value, name, indent, saved, field)
    indent = indent or ""
    saved = saved or {}
    field = field or name
